...
export const metadata: Metadata = {
  title: 'DMCA & Copyright Policy — VictorMdeia',
  description: 'DMCA Takedown and Copyright Notice procedures for VictorMdeia.net.',
};
  ...
  return (
    <div className="container" style={{ padding: '3.5rem 1.25rem', maxWidth: '860px', lineHeight: 1.7 }}>
      ...
      <p style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem' }}>
        VictorMdeia respects the intellectual property rights of others. If you believe your copyrighted work is accessible on VictorMdeia.net in a way that constitutes copyright infringement, please notify us.
      </p>
      ...
      <div style={{ background: 'var(--bg-tertiary)', padding: '1rem', borderRadius: 'var(--radius-md)' }}>
        <strong>Copyright Agent:</strong> VictorMdeia Legal Team<br />
