...
export const metadata: Metadata = {
  title: 'Accessibility — VictorMedia',
  description: 'VictorMedia commitment to web accessibility and WCAG standards.',
};
  ...
  return (
    <div className="container" style={{ padding: '3.5rem 1.25rem', maxWidth: '860px', lineHeight: 1.7 }}>
      ...
      <p style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem' }}>
        VictorMedia is committed to ensuring digital accessibility for people with disabilities. We continuously improve user experience for everyone by applying relevant WCAG accessibility standards.
      </p>
